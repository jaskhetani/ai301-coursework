...
I have experience with Python and would prefer just that, I want to focus on quick Python fixes in AI/ML-related projects. I want to learn the leading AI/ML frameworks: numpy, pandas, LangChain, or anything like that. Apart from that easy fixes in html/css/js is also cool cause I have learnt the language just not used it enough to perform complex fixes. I have worked and would love to work with opencv to understand it further.